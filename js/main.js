...
function renderHero(el, settings) {
  ...
  const primaryButtonUrl = getSafeUrl(settings.buttonUrl || "blog.html", "blog.html");
  const secondaryButtonUrl = getSafeUrl(settings.subButtonUrl || "about.html", "about.html");
  ...
  el.innerHTML = `
    <div class="profile-mini">
      ...
      <div class="profile-mini__content">
        ...
        <a href="about.html" class="btn btn--small btn--accent">もっと知る →</a>
      </div>
    </div>
  `;
}
